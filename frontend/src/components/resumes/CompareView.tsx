...
export function CompareView() {
  const { resumeVersions, compareVersionIds, setCompareVersions, getResumeById } = useAppStore();
  
  const version1 = compareVersionIds.v1 ? getResumeById(compareVersionIds.v1) : null;
  const version2 = compareVersionIds.v2 ? getResumeById(compareVersionIds.v2) : null;
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="flex-1 w-full">
            ...
            <Select
              ...
              onChange={(e) =>
                setCompareVersions({ ...compareVersionIds, v1: e.target.value || null })
              }
          ...
          <div className="flex-1 w-full">
            ...
            <Select
              ...
              onChange={(e) =>
                setCompareVersions({ ...compareVersionIds, v2: e.target.value || null })
              }
              options={versionOptions}
            />
          </div>
          ...
          {stats && (
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">
                  <span className="text-slate-500 font-medium">{stats.unchanged}</span>{' '}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: parseMarkdown(version1.content) }}
              />
            </Card>
            ...
            <Card>
              ...
              <div
                className="max-h-[400px] overflow-y-auto prose  prose-sm max-w-none p-4 bg-slate-100 rounded-lg scrollbar-thin"
                dangerouslySetInnerHTML={{ __html: parseMarkdown(version2.content) }}
              />
            </Card>
          </div>
        </>
